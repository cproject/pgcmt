...
urlpatterns = patterns('',
    ...
    url(r'^create/project/$','pgcmt.ticket.views.createProject',name='CreateProject'),
    url(r'^create/ticket/$','pgcmt.ticket.views.createTicket',name='CreateTicket'),
    url(r'^projects/$','pgcmt.ticket.views.listProjects',name='Projects'),
    url(r'^search/$','pgcmt.ticket.views.searchTicket',name='searchTicket'),
    url(r'^project/(?P<project_name>\w+)/$','pgcmt.ticket.views.showProject',name='showProject'),
    url(r'^user/(?P<username>\w+)/$','pgcmt.ticket.views.showUser',name='showUser'),
    url(r'^requestuser/(?P<requestuser_id>\w+)/$','pgcmt.ticket.views.showRequestUser',name='showRequestUser'),
    url(r'^login/$','pgcmt.auth.views.check_login',name='Login'),
    url(r'^logout/$','pgcmt.auth.views.logout_view',name='Logout'),
